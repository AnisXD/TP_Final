...
<asp:Content ID="Content2" ContentPlaceHolderID="ContenidoColIzUsuario" runat="server">
    ...
    <h2>Filtrar por:</h2>
        ...
        <asp:DropDownList ID="ddlPrecio" runat="server" CssClass="ControlesASP"> </asp:DropDownList>
       ...
       <asp:ListView ID="lvwCelulares" runat="server" GroupItemCount="2">
           ...
           <ItemTemplate>
               <td runat="server" style="background-color: #E0FFFF;color: #333333;">
                   ...
                   <br />
                   <asp:Button ID="BtnAgregarAlCarrito" runat="server" Text="Agregar al carrito" CssClass="Boton" CommandArgument='<%# Eval("Modelo") %>' CommandName="EventoAgregarAlCarrito" OnCommand="BtnAgregarAlCarrito_Command" />
                   <br /></td>
           </ItemTemplate>
