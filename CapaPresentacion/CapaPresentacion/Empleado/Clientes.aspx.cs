...
//            NUsuario Obj = new NUsuario();
//            if (Obj.Insertar(txtDNI.Text, txtApellido.Text, txtNombre.Text, Convert.ToInt32(ddlFProvincia.SelectedValue), Convert.ToInt32(ddlFLocalidad.SelectedValue), txtDireccion.Text, txtTelefono.Text), txtContraseña.Text)
//            {
//                limpiarTxt();
