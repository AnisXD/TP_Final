<%@ Page Title="" Language="C#" MasterPageFile="~/Empleado/PaginaMaestraEmpleado.master" AutoEventWireup="true" CodeBehind="Empleados.aspx.cs" Inherits="CapaPresentacion.Empleado.Empleados" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContenidoColPpalEmpleado" runat="server">
    ...
    <div id="FormClientes" class="Form">
        ...
        <asp:GridView ID="gvwEmpleados" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" AutoGenerateSelectButton="True" OnSelectedIndexChanged="gvwEmpleados_SelectedIndexChanged" Width="100%" Font-Size="Small" RowStyle-Height="40px">
        ...
        <table>
            <tr>
                <td style="text-align: center;" class="auto-style1">LEGAJO:
                </td>
