...
namespace CapaPresentacion.Empleado
{
    public partial class Empleados : System.Web.UI.Page
    {
        ...
        {
            string IdRol = "E";// C = Cliente , A = Administrador, E = Empleado, V = Vendedor
            NUsuario Obj = new NUsuario();
            gvwEmpleados.DataSource = Obj.BuscarPorRol(IdRol);
            gvwEmpleados.DataBind();
            lblTotalRegistros.Text = "Registros encontrados: " + gvwEmpleados.Rows.Count;
        }
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            NUsuario Obj = new NUsuario();
            if (Obj.Insertar(txbDNI.Text, txbNombre.Text, txbApellido.Text, txbTelefono.Text, Convert.ToInt32(ddlProvincia.SelectedItem.Value), Convert.ToInt32(ddlLocalidad.SelectedItem.Value), txbDireccion.Text, txbClave.Text, 'E'))
            {
        ...
        {
            char IdRol = 'E'; // C = Cliente , A = Administrador, E = Empleado
            string DNI;
            string APELLIDO;
            ...
            if (cbDNI.Checked == true)
            {
                ...
                NUsuario Obj = new NUsuario();
                gvwEmpleados.DataSource = Obj.BuscarUsuarioPorDNI(DNI, IdRol);
                gvwEmpleados.DataBind();
                lblTotalRegistros.Text = "Registros encontrados: " + gvwEmpleados.Rows.Count;
            }
            ...
            if (CheckBox1.Checked == true)
            {
                ...
                NUsuario Obj = new NUsuario();
                gvwEmpleados.DataSource = Obj.BuscarUsuarioPorApellido(APELLIDO, IdRol);
                gvwEmpleados.DataBind();
                lblTotalRegistros.Text = "Registros encontrados: " + gvwEmpleados.Rows.Count;
            }
        }
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (obj.Editar(txbDNI.Text, txbNombre.Text, txbApellido.Text, txbTelefono.Text, Convert.ToInt32(ddlProvincia.SelectedItem.Value), Convert.ToInt32(ddlLocalidad.SelectedItem.Value), txbDireccion.Text, 'E'))
                {
                    Response.Redirect("/Empleado/Empleados.aspx");
        ...
        protected void gvwEmpleados_SelectedIndexChanged(object sender, EventArgs e)
        {
            this.txbDNI.Text = gvwEmpleados.SelectedRow.Cells[1].Text;
            this.txbNombre.Text = gvwEmpleados.SelectedRow.Cells[2].Text;
            this.txbApellido.Text = gvwEmpleados.SelectedRow.Cells[3].Text;
            this.txbTelefono.Text = gvwEmpleados.SelectedRow.Cells[4].Text;
            BuscarProvincia(gvwEmpleados.SelectedRow.Cells[5].Text);
            CargarDDL_Localidad(ddlLocalidad, Convert.ToInt32(ddlProvincia.SelectedValue));
            BuscarLocalidad(gvwEmpleados.SelectedRow.Cells[6].Text);
            this.txbDireccion.Text = gvwEmpleados.SelectedRow.Cells[7].Text;
            btnAgregar.Enabled = false;
            btnEditar.Enabled = true;
            btnEliminar.Enabled = true;
            txbClave.Enabled = false;
