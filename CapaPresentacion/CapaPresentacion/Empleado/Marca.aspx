...
<asp:Content ID="Content2" ContentPlaceHolderID="ContenidoColIzEmpleado" runat="server">
    ...
    <div id="Filtros" style="text-align:left;">
        ...
        <asp:DropDownList ID="ddlMarca" runat="server" AutoPostBack="True" CssClass="Ddl" >
        </asp:DropDownList>
        ...
        <asp:DropDownList ID="ddlIdMarca" runat="server" AutoPostBack="True" CssClass="Ddl" >
        </asp:DropDownList>
        ...
        <table style=" width:100%; font-size:20px; color:black;">
            <tr>
                <td style=" width: 30%; height: 26px;">
                    <asp:Label ID="lblIdMarca" runat="server" text="Id: " CssClass="LabelNegritaLarga"></asp:Label>
                </td>
                <td style="text-align:left; height: 26px;">
                    <asp:TextBox ID="txtIdMarca" runat="server" OnTextChanged="txtIdMarca_TextChanged" AutoPostBack="True" CssClass="ControlesASP" CausesValidation="True" MaxLength="15" Style="text-transform: uppercase"></asp:TextBox>
                </td>
             </tr>
            <tr>
                <td style=" width: 30%; height: 26px;">
                    <asp:Label ID="lblNombreMarca" runat="server" Text="Nombre: " CssClass="LabelNegritaLarga"></asp:Label>
                </td>
                <td style="text-align:left; height: 26px;">
                    <asp:TextBox ID="txtNombreMarca" runat="server" MaxLength="20" CssClass="ControlesASP" Style="text-transform: uppercase"></asp:TextBox>
                </td>
            </tr>
          </table>
        <br />
