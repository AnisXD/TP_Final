<%@ Page Title="" Language="C#" MasterPageFile="~/Empleado/PaginaMaestraEmpleado.master" AutoEventWireup="true" CodeBehind="CelularesEmpleado.aspx.cs" Inherits="CapaPresentacion.Empleado.Celulares" %>
        ...
        <div id="Administrar" title="Administrar">
            ...
            <tr>
                ...
                <td class="auto-style2">
                  <asp:TextBox ID="txtModeloEditar" runat="server" CssClass="ControlesASP" AutoPostBack="True" OnTextChanged="txtModelo2_TextChanged" TextMode="Number" CausesValidation="True"></asp:TextBox>
                </td>
