...
<asp:Content ID="Content3" ContentPlaceHolderID="ContenidoColPpalCliente" runat="server">
    ...
    <div id="CarritoEmpleado" class="Form">
        ...
        <table style=" width: 100%; height: 185px; font-size:20px">
            <tr>
            ...
            <tr>
                 ...
                 <td style="text-align:center; height: 25px;">
                    <asp:Button ID="btnAnadir" runat="server" Text="Añadir" CssClass="Boton" OnClick="btnAnadir_Click" PostBackUrl="~/Comprar.aspx" />
                </td>
            </tr>
            </table>
            <br />
