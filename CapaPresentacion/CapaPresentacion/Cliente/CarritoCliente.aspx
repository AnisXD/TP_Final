...
<asp:Content ID="Content3" ContentPlaceHolderID="ContenidoColPpalCliente" runat="server">
    ...
    <div id="Carrito" class="Form">
        ...
        <asp:Label ID="txtLegajo" runat="server" Text="E-99999" CssClass="Label"></asp:Label>
        ...
        <div id="DivCarritoTopBottom">
            ...
            <table class="TablaCarrito">
                ...
                <tr>
                    ...
                    <td style="text-align: left; height: 26px;">
                        <asp:DropDownList ID="ddlCantidad" runat="server" AutoPostBack="True" CssClass="DropDownListFull" Visible="True"></asp:DropDownList></td>
                </tr>
                <tr>
                    <td style="text-align: left; width: 50%;"></td>
                    <td style="text-align: center; height: 25px;">
                        <asp:Button ID="btnAnadir" runat="server" Text="Añadir" CssClass="Boton" OnClick="btnAnadir_Click" /></td>
                </tr>
            </table>
