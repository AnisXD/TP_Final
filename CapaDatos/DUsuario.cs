...
namespace CapaDatos
{
    public class DUsuario
    {
        ...
        private void ParametrosUsuario(ref SqlCommand Comando, Usuario usuario)
        {
            ...
            SqlParametros = Comando.Parameters.Add("@IDPROVINCIAUSU", SqlDbType.Int);
            SqlParametros.Value = Convert.ToInt32(usuario.Direccion.IdProvincia);
            SqlParametros = Comando.Parameters.Add("@IDLOCALIDADUSU", SqlDbType.Int);
            SqlParametros.Value = Convert.ToInt32(usuario.Direccion.IdLocalidad);
            SqlParametros = Comando.Parameters.Add("@DIRECIONUSU", SqlDbType.VarChar, 30);
            SqlParametros.Value = usuario.Direccion.Calle_y_Altura;
            SqlParametros = Comando.Parameters.Add("@CONTRASEÑAUSU", SqlDbType.VarChar, 15);
